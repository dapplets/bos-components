const nearSocialTargetPostId =
  context.networkId === 'mainnet'
    ? 'dappletsproject.near/119034910'
    : 'bos.dapplets.testnet/168034335'
  ...
  chapters: [
      ...
      pages: [
        {
          ...
          status: [],
          content:
            'The current mutation is highlighted with a star. To add a “favorite” status to a mutation on the current page, simply click on the star. his mutation will become active when you open the website in a new tab.',
        },
        {
    ...
    },
    {
      ...
      if: {
        ...
        widgetSrc: { eq: '${REPL_ACCOUNT}/widget/Paywall.Main' },
      },
      arrowTo: 'context',
      pages: [
        {
          id: '${REPL_ACCOUNT}/app/Paywall/1',
          status: [],
          title: 'Paywall app',
      ...
      pages: [
        {
          ...
          content:
            'We add the app control panel to each post. You can add widgets to the post or panel to extend the functionality of the site.',
        },
      ],
      skin: 'META_GUIDE',
    },
      ...
      pages: [
        {
          ...
          title: 'Apps control panel',
          content:
            '[See other Mutable Web facilities on NEAR Social](https://social.dapplets.org/mob.near/widget/ProfilePage?accountId=dappletsproject.near)',
        },
      ],
      skin: 'META_GUIDE',
    },
      ...
      pages: [
        {
          ...
          title: 'Tipping app',
          content:
            'If you want to thank the author of the post you like, you can send them a tip through our application.',
        },
      ],
      skin: 'META_GUIDE',
    },
      ...
      pages: [
        {
          ...
          title: 'Apps control panel',
          content:
            'We’ve added a special container to all posts. This allows users to attach widgets that extend the possibilities of Near Social.',
        },
      ],
      skin: 'META_GUIDE',
    },
      ...
      pages: [
        {
          ...
          title: 'Apps control panel',
          content:
            '[See other Mutable Web facilities on X](https://augm.link/mutate/?t=https%3A%2F%2Ftwitter.com%2FMrConCreator&m=${REPL_ACCOUNT}%2Fmutation%2FSandbox)',
        },
      ],
      skin: 'META_GUIDE',
    },
      ...
      pages: [
        {
          ...
          content:
            'The WebGuide is also an application. Any user can create a guide to explain a workflow to other users. The WebGuide consists of callouts pointing to UI elements (original or embedded by other applications).',
        },
        {
          ...
          content:
            '![](https://raw.githubusercontent.com/dapplets/bos-components/main/assets/webguide-004.png)\n\nWeb Guides can consist of several chapters.',
        },
        {
