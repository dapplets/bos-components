...
const QuestionMarkIcon = ({ isActive }) => (
...
return (
  <ButtonActionWrapper
    title={isActive ? 'Stop Web Guide' : 'Run Web Guide'}
    $isActive={isActive}
    onClick={onClick}
    data-mweb-context-type="mweb-overlay-action"
    data-mweb-context-parsed={JSON.stringify({
      id: `web-guide-action`, // ToDo: rule of SID (semantic context id) should be applied
      type: 'web-guide-action',
      appId: 'web-guide',
    })}
  >
    <ImgButtonWrapper>
      <QuestionMarkIcon isActive={isActive} />
    </ImgButtonWrapper>
  </ButtonActionWrapper>
)
